...
-- DialogUI configuration: font size/face, frame scale, and the text animation
-- toggle. All persisted account-wide in DialogUISettings and applied at
-- login (and live when changed from the options panel).
